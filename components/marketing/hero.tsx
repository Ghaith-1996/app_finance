      ...
      <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-3 text-sm text-slate-500">
            <span className="inline-flex items-center gap-2 rounded-xl border border-white/[0.06] bg-surface-raised px-4 py-2">
          ...
          <div className="flex flex-wrap gap-3 text-sm text-slate-500">
            {sourceTags.map((source) => (
              <span
                key={source.name}
                className="inline-flex items-center gap-2 rounded-xl border border-white/[0.06] bg-surface-raised px-3 py-2"
              >
          ...
          <div className="relative grid gap-4 p-6">
            <div className="grid gap-4 sm:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="grid gap-4">
                ...
                <Panel className="space-y-4 bg-[#0d1520] p-5">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <p className="text-sm text-slate-500">Daily brief</p>
                      <p className="text-lg font-semibold text-white">
